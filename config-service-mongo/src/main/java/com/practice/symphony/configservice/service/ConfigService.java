...
public class ConfigService {
	...
	public Config getConfig(int tenantId) {
		...
		if (configFromMongo.getId() > 0 && configFromMongo.getAccount() != null) {
			logger.info("Valid Object from DB. Expired in cache, getting from mongo and adding to cache again");
